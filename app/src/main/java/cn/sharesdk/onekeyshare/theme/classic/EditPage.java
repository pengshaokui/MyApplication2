...
//	private static final int DIM_COLOR = 0xffffffff;
...
//			rlDialog.setBackgroundColor(0xc0323232);
			rlDialog.setBackgroundColor(0xffffffff);
			...
			rlPage.setBackgroundColor(0xffffffff);
...
//			llTitle.setBackgroundResource(resId);
			llTitle.setBackgroundColor(0xff323232);
//		}
